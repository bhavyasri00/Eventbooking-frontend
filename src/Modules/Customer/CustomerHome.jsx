...
export default function CustomerHome() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Tabs */}
      <div className="border-b border-gray-200 bg-opacity-80 backdrop-blur">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {activeTab === "dashboard" && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-opacity-80 backdrop-blur rounded-lg shadow p-6">
        ...
        {/* Account Tab */}
        {activeTab === "account" && (
          <div className="bg-opacity-80 backdrop-blur rounded-lg shadow p-8 max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-900 py-2 px-4 bg-opacity-60 backdrop-blur rounded-lg">
                    {user.email}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900 py-2 px-4 bg-opacity-60 backdrop-blur rounded-lg capitalize">
                    {user.role}
                  </p>
                </div>
              ...
              <div className="mt-12 pt-12 border-t border-gray-200">
                ...
                {loading ? (
                  ...
                  <div className="bg-opacity-60 backdrop-blur rounded-lg p-8 text-center">
                    <svg
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {bookings.map((booking) => (
                      <div
                        key={booking.id}
                        className="bg-opacity-80 backdrop-blur border border-gray-200 rounded-lg shadow overflow-hidden hover:shadow-lg transition"
                      >
