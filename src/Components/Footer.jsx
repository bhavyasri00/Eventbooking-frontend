...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 text-gray-900 font-semibold">
      {/* Main Footer Content */}
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-6 sm:py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-2xl font-bold text-gray-900">EVENT PRO</h3>
              </div>
            ...
            <div className="space-y-4 text-sm text-gray-700">
              <div>
                ...
                <p className="text-gray-700">EVENT BOOKING PLATFORM</p>
              </div>
              <div>
                <span className="font-semibold text-gray-900 block mb-1">
                  CIN:
                </span>
                <p className="text-gray-700">U62099TS2024PTC180666</p>
              </div>
              <div>
                <span className="font-semibold text-gray-900 block mb-1">
                  GST:
                </span>
                <p className="text-gray-700">36AAHCE9506H1ZH</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 mb-8">
              <a
                href="#"
                className="bg-red-500 text-white p-3 rounded-full hover:bg-gray-900 hover:text-white transition"
                title="Instagram"
              >
                <svg
                  className="h-5 w-5"
          ...
          <div className="flex flex-col">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
              <input
                ...
                className="px-4 py-2 rounded-lg text-gray-900 border border-gray-300 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500"
              />
              <button
                type="submit"
                className="bg-red-500 hover:bg-gray-900 text-white font-bold px-6 py-2 rounded-full transition"
              >
                Subscribe
              </button>
            </form>
      ...
      {/* Copyright */}
      <div className="bg-gray-200 py-2 px-4 md:px-8 text-center text-gray-900 text-sm border-t border-gray-300 font-semibold">
