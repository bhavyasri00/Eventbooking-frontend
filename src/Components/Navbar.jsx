            ...
            <div className="hidden md:flex space-x-4 items-center relative user-menu-container">
              {isLoggedIn ? (
                ...
                <button
                  ...
                  className="font-bold text-black border-b-2 border-transparent hover:border-red-500 pb-1 transition"
                >
                  Login
                </button>
              )}
              ...
              <div className="border-t border-gray-200 my-4 pt-4">
                {isLoggedIn ? (
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-3 rounded-lg font-semibold text-black hover:bg-red-50 hover:text-red-500 transition"
                  >
                    Login
                  </button>
                )}
