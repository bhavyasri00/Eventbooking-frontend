...
export const eventService = {
  ...
  createEvent: async (eventData) => {
    try {
      ...
      // Handle image - convert data URL to blob if needed
      if (
        eventData.image &&
      ...
      // Send FormData - DO NOT set Content-Type header, let axios handle it
  ...
  updateEvent: async (eventId, eventData) => {
    try {
      ...
      console.error("Event update error - Full error:", error);
      console.error(
        "Event update error - Response data:",
        error.response?.data
      );
      console.error("Event update error - Status:", error.response?.status);
      console.error("Event update error - Message:", error.message);
      throw error.response?.data || error;
    }
  },
